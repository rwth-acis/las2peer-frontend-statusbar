...
class Las2peerFrontendStatusbar extends PolymerElement {
    ...
    static get template() {
      return html`
        ...
        <openidconnect-signin id="oidcButton" style="display:none"
        ...
        <iron-dropdown id="dropdown">
            <div class="dropdown-content" slot="dropdown-content" id="dropdownLoggedIn" hidden$="[[!loggedIn]]">
                <ul tabindex="0">
                    ...
                    <!-- Since I did not figure out how to log somebody back in yet, logging out right now is only possible by closing the browser -->
                    <!-- <li><a href="javascript:void(0)" on-click="_logout">Logout</a></li> -->
                </ul>
            </div>
            <div id="dropdownLoggedOut" class="dropdown-content" slot="dropdown-content" hidden$="[[loggedIn]]">
                <ul tabindex="0">
                    <li><a href="javascript:void(0)" on-click="_login">Login</a></li>
                </ul>
            </div>
            </template>
        </iron-dropdown>
